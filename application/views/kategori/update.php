					...
					<div class="row">
						<div class="col-md-12">
							<div class="card shadow">
								...
								<div class="card-body">
									<form action="<?= base_url('kategori/update/' . $kategori['kategori_id']) ?>" method="POST">
										<div class="form-row">
											<div class="form-group col-md-6">
												<label><strong>Kode Kategori</strong></label>
												<input value="<?= $kategori['kategori_code'] ?>" type="text" name="kategori_code" placeholder="Masukkan Kode Kategori" class="form-control">
												<?= form_error('kategori_code', '<small class="pl-3 text-danger">', '</small>'); ?>
											</div>
											<div class="form-group col-md-6">
												<label><strong>Nama kategori</strong></label>
												<input value="<?= $kategori['kategori_name'] ?>" type="text" name="kategori_name" placeholder="Masukkan Nama Kategori" class="form-control">
